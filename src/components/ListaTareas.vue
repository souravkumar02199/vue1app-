    ...
    <template>
      ...
      <tbody>
        <tr v-for="(item, index) in tareas" :key="index">
          ...
          <td><v-btn depressed color="primary" @click="processMark(item)">Mark</v-btn></td>
          <td><v-btn depressed color="primary" @click="processEdit(item,index)">Edit</v-btn></td>
          <td><v-btn depressed color="error" @click="eliminarTarea(item.id)">Delete</v-btn></td>
        </tr>
      </tbody>
    </template>
  </v-simple-table>
